...
class OfficialAccountPage(BasePage):
    ...
    __locators = {
        ...
        '键盘': (MobileBy.IOS_PREDICATE, 'name CONTAINS "keyboardclose"'),
        ...
        # '和飞信-头像': (MobileBy.XPATH, '//XCUIElementTypeStaticText[@name="和飞信, 和飞信负一屏直击企业痛点 专注为企业提供移动化办公解决方案 为企业、团队、群体提供个性化ict门户 为企业提高管理和运作效率。"]'),
        '和飞信-头像': (MobileBy.IOS_PREDICATE, 'name CONTAINS "和飞信负一屏直"'),
