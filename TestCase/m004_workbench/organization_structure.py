...
class OrganizationStructureAllTest(TestCase):
    ...
    def test_ZZJG_0008(self):
        ...
        osp.click_back_button()
        # 1.弹窗隐藏(部分验证点变动)
        self.assertEquals(osp.page_should_contain_text2("添加成员加入团队", 3), False)
    ...
    def test_ZZJG_0011(self):
        ...
        time.sleep(2)
        self.assertEquals(ecp.page_should_contain_text2("大佬1", 3), False)
        self.assertEquals(ecp.page_should_contain_text2("大佬2", 3), False)
        self.assertEquals(ecp.page_should_contain_text2("大佬3", 3), False)
        self.assertEquals(ecp.page_should_contain_text2("大佬4"), True)
